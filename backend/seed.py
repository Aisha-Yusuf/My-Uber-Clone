...
def seed_data():
    ...
    ride1 = Ride(customer_id=customer1.id, driver_id=driver1.id, date=date.today(), start_time=time(8, 0), end_time=time(10, 0),
                pickup_location='Location A', drop_location='Location B', amount=25.0)
    ride2 = Ride(customer_id=customer2.id, driver_id=driver2.id, date=date.today(), start_time=time(9, 0), end_time=time(11, 0),
                pickup_location='Location C', drop_location='Location D', amount=30.0)
